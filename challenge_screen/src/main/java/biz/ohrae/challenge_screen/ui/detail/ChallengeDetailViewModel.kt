            ...
            repo.getChallenge(id).flowOn(Dispatchers.IO).collect { it ->
                ...
                if (it.data != null) {
                    ...
                    if (isJoined) {
                        ...
                        val todayNumber = Utils.getDaysFromStart(challengeData.start_date.toString())
                        Timber.e("todayNumber : $todayNumber")

                        var successCount = 0
                        var failCount = 0
                        val remainCount = challengeData.total_verification_cnt - todayNumber
